...
- [OCI Operations Training](https://cloud.oracle.com/en_US/iaas/training/operations)
- [OCI Advanced Training](https://cloud.oracle.com/en_US/iaas/training/advanced)
- [OCI Docs](https://docs.cloud.oracle.com/iaas/Content/home.htm)
- [OCI Terraform Provider Docs](https://www.terraform.io/docs/providers/oci/index.html)

## Tools
- [OCI Python SDK](https://oracle-cloud-infrastructure-python-sdk.readthedocs.io/en/latest/index.html)
